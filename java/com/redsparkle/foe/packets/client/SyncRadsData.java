package com.redsparkle.foe.packets.client;
 ...
 */
public class SyncRadsData extends AbstractMessage.AbstractClientMessage<SyncRadsData> {
    ...
    public SyncRadsData(CapabilityRadiation.IRadiation rads) {
        this.rads = rads.getRadiation();
        this.maxRads = rads.getMaxRadiation();
    }

    @Override
    protected void read(PacketBuffer buffer) throws IOException {
        this.rads = buffer.readInt();
        this.maxRads = buffer.readInt();
    }

    @Override
    protected void write(PacketBuffer buffer) throws IOException {
        buffer.writeInt(this.rads);
        buffer.writeInt(this.maxRads);
    }

    @Override
    public void process(EntityPlayer player, Side side) {
        final CapabilityRadiation.IRadiation rads = player.getCapability(CapabilityRadiation.RADS, null);
        rads.setRadiation(this.rads);
        rads.setMaxRadiation(this.maxRads);
    }
}