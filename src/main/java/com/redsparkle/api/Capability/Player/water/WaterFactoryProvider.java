...
public class WaterFactoryProvider implements IWaterCapability, ICapabilitySerializable<NBTTagCompound> {
    ...
    public void setWater(Integer newWaterLevel) {
        waterLevel = (basicWater + newWaterLevel);
    }

    public void addWater(Integer addWaterLevel) {
        if ((waterLevel + addWaterLevel) > 100) {
            waterLevel = 100;
        } else {
            waterLevel = (waterLevel + addWaterLevel + basicWater);
        }
    }

    public void removeWater(Integer removeWaterLevel) {
        waterLevel = (waterLevel - removeWaterLevel + basicWater);
    }
