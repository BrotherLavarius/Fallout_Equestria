 ...
 */
public class Five_mm_minigun extends Item_SaggleBagGun {

    public Five_mm_minigun(String itemName, String side, GlobalsGunStats params, Item ClipItem, Item AmmoItem) {
