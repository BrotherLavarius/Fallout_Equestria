 ...
 */
public class flammenwarfer extends Item_SaggleBagGun {

    public flammenwarfer(String itemName, String side, GlobalsGunStats params, Item ClipItem, Item AmmoItem) {
